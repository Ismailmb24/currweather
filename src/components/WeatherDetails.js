...
export default function WeatherDetails({ data }) {
  ...
  return (
    <section className={style.more_detail}>
      <Detail
        icon={<Droplet size={35} className={style.icon} />}
        icon2={<Droplet size={45} className={style.icon2} />}
        title={"Humidity"}
      ...
      <Detail
        ...
        icon2={<Sunrise size={45} className={style.icon2} />}
        title={"Sunrise"}
      ...
      <Detail
        ...
        icon2={<Sunset size={45} className={style.icon2} />}
        title={"Sunset"}
      ...
      <Detail
        ...
        icon2={<Wind size={45} className={style.icon2} />}
        title={"Wind"}
